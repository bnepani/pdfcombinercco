...
public class ReporterTest {
	...
	public void allLevelsFilledTest() throws Exception {
		...
		Reporter reporter = new Reporter("Data//CPQ_sample1.xml", "Data//CPQ_Proposal_Disclaimer__c.xml", "Data//CPQ_Map_Panel_Order_Pref__c.xml", null, null, false, false, false, pdfCombinerFile, true, true, null);
	...
	public void locationFlavourReportTest() throws Exception {
		...
		Reporter reporter = new Reporter("Data//CPQ_sample1.xml", "Data//CPQ_Proposal_Disclaimer__c.xml", "Data//CPQ_Map_Panel_Order_Pref__c.xml", null, null, true, true, false, pdfCombinerFile, true, true,null);
		showReporterInfo(reporter);
	}
	...
	public void locationFlavourReportWithMapLocationNumberTest() throws Exception {
		...
		Reporter reporter = new Reporter("Data//CPQ_sample1.xml", "Data//CPQ_Proposal_Disclaimer__c.xml", "Data//CPQ_Map_Panel_Order_Pref__c_with_data.xml", null, null, true, true, false, pdfCombinerFile, true, true,null);
		showReporterInfo(reporter);
	}
	...
	public void locationFlavourReportAllSummariesTest() throws Exception {
		...
		Reporter reporter = new Reporter("Data//CPQ_FourLevelsSample1.xml", "Data//CPQ_Proposal_Disclaimer__c.xml", "Data//CPQ_Map_Panel_Order_Pref__c.xml", null, null, true, true, true, pdfCombinerFile, true, true,null);
		showReporterInfo(reporter);
	}
	...
	public void BUG_2013_05_04_01Test() throws Exception {
		...
		Reporter reporter = new Reporter("Data//CPQ_sample1.xml", "Data//CPQ_Proposal_Disclaimer__c.xml", "Data//CPQ_Map_Panel_Order_Pref__c.xml", null, null, true, false, false, pdfCombinerFile, true, true,null);
		showReporterInfo(reporter);
	}
	...
	public void oneLevelFilledWithShippingInstructionsTest() throws Exception {
		...
		Reporter reporter = new Reporter("Data//CPQ_sample1.xml", "Data//CPQ_Proposal_Disclaimer__c.xml", "Data//CPQ_Map_Panel_Order_Pref__c.xml", "Data//CPQ_ShippingInstructions_With_Records.xml", null, false, false, false, pdfCombinerFile, true, true,null);
		showReporterInfo(reporter);
	}
	...
	public void renderAllDisclaimersWithProgramSummaryIncludingIndividualMarketTest() throws Exception {
		...
		Reporter reporter = new Reporter("Data//CPQ_sample1.xml", "Data//CPQ_Proposal_Disclaimer__c.xml", "Data//CPQ_Map_Panel_Order_Pref__c.xml", null, null, false, false, false, pdfCombinerFile, true, false,null);
		showReporterInfo(reporter);
	}
