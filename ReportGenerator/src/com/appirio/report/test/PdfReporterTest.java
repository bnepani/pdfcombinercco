...
public class PdfReporterTest {
	...
	public void getPageNumberFromLineTest() {
		Assert.assertEquals(1, PdfReporter.getPageNumberFromLine(" Package Albaquerque DMA,,,,,,..............................................................................................................................................,,,,,,1"));
		Assert.assertEquals(258, PdfReporter.getPageNumberFromLine(" Package Albaquerque DMA,,,,,,..............................................................................................................................................,,,,,,258"));
	}
	...
	public void allLevelsFilledTest() throws Exception {
		...
		PdfReporter reporter = new PdfReporter("Data//CPQ_sample1.xml", "Data//CPQ_Proposal_Disclaimer__c.xml", "Data//CPQ_Map_Panel_Order_Pref__c.xml", null, false, false, false, false, pdfCombinerFile, null);
	...
	public void locationFlavourReportTest() throws Exception {
		...
		PdfReporter reporter = new PdfReporter("Data//CPQ_sample1.xml", "Data//CPQ_Proposal_Disclaimer__c.xml", "Data//CPQ_Map_Panel_Order_Pref__c.xml", null, false, true, true, false, pdfCombinerFile, null);
		showReporterInfo(reporter);
	}
	...
	public void locationFlavourReportWithMapLocationNumberTest() throws Exception {
		...
		PdfReporter reporter = new PdfReporter("Data//CPQ_sample1.xml", "Data//CPQ_Proposal_Disclaimer__c.xml", "Data//CPQ_Map_Panel_Order_Pref__c_with_data.xml", null, false, true, true, false, pdfCombinerFile, null);
		showReporterInfo(reporter);
	}
	...
	public void locationFlavourReportAllSummariesTest() throws Exception {
		...
		PdfReporter reporter = new PdfReporter("Data//CPQ_FourLevelsSample1.xml", "Data//CPQ_Proposal_Disclaimer__c.xml", "Data//CPQ_Map_Panel_Order_Pref__c.xml", null, false, true, true, true, pdfCombinerFile, null);
		showReporterInfo(reporter);
	}
	...
	public void BUG_2013_05_04_01Test() throws Exception {
		...
		PdfReporter reporter = new PdfReporter("Data//CPQ_sample1.xml", "Data//CPQ_Proposal_Disclaimer__c.xml", "Data//CPQ_Map_Panel_Order_Pref__c.xml", null, false, true, false, false, pdfCombinerFile, null);
		showReporterInfo(reporter);
	}
	...
	public void oneLevelFilledWithShippingInstructionsTest() throws Exception {
		...
		PdfReporter reporter = new PdfReporter("Data//CPQ_sample1.xml", "Data//CPQ_Proposal_Disclaimer__c.xml", "Data//CPQ_Map_Panel_Order_Pref__c.xml", "Data//CPQ_ShippingInstructions_With_Records.xml", false, false, false, false, pdfCombinerFile, null);
		showReporterInfo(reporter);
	}
	...
	public void isMarketLevelTest() {
		...
		Assert.assertFalse(PdfReporter.isMarketLevel(pdfCombinerFile, 0));
		Assert.assertFalse(PdfReporter.isMarketLevel(pdfCombinerFile, 1));
		Assert.assertTrue(PdfReporter.isMarketLevel(pdfCombinerFile, 2));
		Assert.assertFalse(PdfReporter.isMarketLevel(pdfCombinerFile, 3));
	}
	...
	public void getPDFCombinerContentEntryListTest() throws Exception {
		...
		// act
		List<PDFCombinerContentEntry> pdfCombinerContentEntryList = PdfReporter.getPDFCombinerContentEntryList(lines);
	...
	private void showReporterInfo(PdfReporter reporter) throws Exception {
		System.out.println("   resulting files ");
		System.out.println(reporter.getGeneratedReport("pdf"));
		System.out.println(reporter.getGeneratedReport("xlsx"));
	}
}